...
buildkonfig {
    ...
    defaultConfigs {
        ...
        buildConfigField(
            FieldSpec.Type.STRING, "WISPR_AUTH_URL",
            gradleStringPropOrNull("wisprAuthUrl") ?: "https://wispr-auth.repebble.com",
            nullable = true,
        )
        buildConfigField(
            FieldSpec.Type.STRING, "KIRINKI_URL",
            gradleStringPropOrNull("kirinkiUrl")
                ?: "https://alice-95200--kirinki-kirinkiweb-transcribe.modal.run",
            nullable = true,
        )
