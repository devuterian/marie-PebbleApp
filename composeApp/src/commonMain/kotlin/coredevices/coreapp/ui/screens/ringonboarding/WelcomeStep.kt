...
internal fun WelcomeStep(
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        // Scrollable so the pinned "Get started" button below stays reachable
        // on short/square screens where the hero + text overflow (MOB-8716).
        Column(
            modifier = Modifier
                .weight(1f)
                .fillMaxWidth()
            ...
            // line-art lines stay black. Multiply needs a light base or the image
            // goes dark, so always use the light container color even in dark mode
            // (MOB-8710).
